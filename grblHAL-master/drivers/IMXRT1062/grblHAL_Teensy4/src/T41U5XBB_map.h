...
#define X_ENABLE_PIN    (12u)
#define X_LIMIT_PIN     (19u)

#if X_GANGED || X_AUTO_SQUARE
#define X2_STEP_PIN      (9u)
#define X2_DIRECTION_PIN (8u)
#define X2_ENABLE_PIN    (12u)
#if X_AUTO_SQUARE
  #define X2_LIMIT_PIN   (20u)
#endif
#endif

#define Y_STEP_PIN      (5u)
#define Y_DIRECTION_PIN (4u)
#define Y_ENABLE_PIN    (12u)
#define Y_LIMIT_PIN     (21u)

#if Y_GANGED || Y_AUTO_SQUARE
#define Y2_STEP_PIN      (11u)
#define Y2_DIRECTION_PIN (10u)
#define Y2_ENABLE_PIN    (12u)
#if Y_AUTO_SQUARE
  #define Y2_LIMIT_PIN   (22u)
#endif
#endif

#define Z_STEP_PIN      (7u)
#define Z_DIRECTION_PIN (6u)
#define Z_ENABLE_PIN    (12u)
#define Z_LIMIT_PIN     (23u)
...
#define SPINDLE_ENABLE_PIN      (40u)
#define SPINDLE_DIRECTION_PIN   (41u)
...
#if KEYPAD_ENABLE
#define KEYPAD_STROBE_PIN   (39u) // I2C ST
#endif
